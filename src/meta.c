...
static const struct MetaClassDescription descriptions[META_CLASS_DESCRIPTIONS_COUNT] = {
    ...
    {0x1CF4C103D0290F37, "unsignedchar", intrinsic1Read, NULL},
    ...
    {0x29653DC4D2D86302, "int16", intrinsic2Read, NULL},
    ...
    {0x606C515AC74B48C2, "EnlightenModule::EnumeAgentUsage", intrinsic4Read, NULL},
    ...
    {0x7A54490338F7688B, "EnlightenModule::EnumeInstanceType", intrinsic4Read, NULL},
    ...
    {0x7B6B9766211625BF, "EnlightenModule::EnumeUpdateMethodWithDefault", intrinsic4Read, NULL},
    ...
    {0xA2435650D27ACF90, "EnlightenModule::EnumeSceneOptimisationMode", intrinsic4Read, NULL},
    ...
    {0xA62FE74CCFA3467C, "EnlightenModule::EnumeDistributedBuildSystem", intrinsic4Read, NULL},
    ...
    {0xBB6BAD6A055D7EDB, "EnlightenModule::EnumeAutoUVSimplificationMode", intrinsic4Read, NULL},
    ...
    {0xC810FA560D267D67, "Map<Symbol,PropertySet,less<Symbol>>", TypeGroupRead, NULL}, // TODO: Change this. It is wrong probably
    ...
    {0xCCE2FC8ABD78A775, "EnlightenModule::EnumeProbeResolutionWithDefault", intrinsic4Read, NULL},
    ...
    {0xDAC65150E4EE6266, "EnlightenModule::EnumeRadiositySampleRate", intrinsic4Read, NULL},
    ...
    {0xFA7FC6889D2A5CFC, "ParticleLODKey", Vector4Read, NULL},
