...
{
    const struct MetaClassDescription description = {0, "MeshSceneLightmapData::Entry", MeshSceneLightmapData__EntryRead, NULL}; // TODO: Find a fix for this stupid problem
...
{
    const struct MetaClassDescription description = {0, "T3LightSceneInternalData::LightmapPage", T3LightSceneInternalData__LightmapPageRead, NULL}; // TODO: FIX THIS! This type is not included in the list of metaClassDescriptions. So I have to do this
    return genericArrayRead(stream, node, flags, &description);
}
